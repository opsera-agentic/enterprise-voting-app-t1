...
# NOTE: The GitHub OIDC provider and role are created by the bootstrap script
#       (scripts/bootstrap-iam-role.sh) before Terraform runs.
#       We reference them here as data sources.
################################################################################

# GitHub OIDC Provider (already exists - created by bootstrap script)
data "aws_iam_openid_connect_provider" "github" {
  url = "https://token.actions.githubusercontent.com"
}

# IAM Role for GitHub Actions (already exists - created by bootstrap script)
